...
var animate = function(){
    // Draw each frame in order, looping back around to the beginning of the animation once you reach the end.
    var spritename = 'kami-walk-00' + (frame + 1) + '.png';
    console.log('Paiting: ' + spritename);
    context.clearRect(0,0,canvas.width,canvas.height);
    drawSprite(spritename, 250, 150);
    frame = (frame + 1) % 3;
};